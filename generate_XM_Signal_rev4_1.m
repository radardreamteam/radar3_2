...
Maxsymbol = 3000; % Max symbol number we generate
stream = DVBstream(numFrames,pilotOn,Maxsymbol);
[BaseBandSignal,SymbolFreq] = QPSK(stream',3e6,samplingFreq,27)
...
% dirPath(1:sigLength)               = DVBgenerate(cyclesPerSymbol,sampsPerCycle, samplingFreq ,numFrames,pilotOn);
