...
for k1 = 1:numTargets
    ...
    rxGain_dB       = 20; %Rx beamformed gain
...
TsysTemp        = 77; %temperature (Kelvin)
chanBW          = 3.68e6; %approximate signal bandwidth
noiseFigure_dB  = 0.4; %for now assume 8 dB receiver noise figure
...
dopplerTx = dot(a,tgt2tx)/norm(tgt2tx);
dopplerRx = dot(a,tgt2rx)/norm(tgt2rx);
